// Toggle the phase-2 web augment (adds an official doc/course to thin learning
// steps). It uses a slow, paid web search, so flip to false for fast/cheap demos.
export const WEB_AUGMENT = false; // validation economy: web-hunted courses wait until content passes
