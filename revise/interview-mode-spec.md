...
**FORM REVIEW ROUND (same day, SHIPPED):** doubled-background/orphan-① fixed (embedded prop) · round/format/seniority as CHIPS (structured for free — chips ARE the data) · worry clause removed, the challenge field is fear's single home (visually distinct, brand-tinted) · ammunition field cut from intake, its question asked warm in the diagnostic after Q1's feedback ("anything you were hoping to work in?") · interviewer ROWS (name/title + about, repeatable) with live URL attempt + upfront honest LinkedIn warning (read-link honest-fail pattern) · company website field · copy honesty ("your answers can be"; "powerful" dropped) · tone threaded to /api/coach (the disclosed gap) · "about two minutes" + four group headers (The interview · You · The room · When) · trim chips read "I've got this cold" in interview mode. Live-verified: 13/13 structural checks, router splits from the challenge alone, structured round rides through, hoping-prompt appears after Q1.
