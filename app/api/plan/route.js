...
TWO CLOCKS (critical — do not conflate them): the plan's guided work is measured in WORKSPACE TIME — each task 30-60 focused minutes, the whole road a few HOURS. The HORIZON below is job-ramp context — how those capabilities spread across a real role's first weeks. Timeboxes and the road always speak workspace time; only the readiness project's phases speak horizon time, clearly framed as the on-the-job arc. Never price a workspace task in job-world half-days.
